...
/* The Tickless idle is disabled to allow the UART interrupts to be received,
 * the application uses UART commands to control the functionality and take user input*/
